...
![Acceleration factor vs number of processes for the parallel code
Performances of the ModeLitz software on the cluster Ada of IDRIS institute (http://www.idris.fr/eng/ada/).](image-1.png)
![Distribution of the total Joule power dissipated in each wire of a 1512 wires inductor (Frequency 50 kHz)
Modeling of a multistrands inductor (6x14x18 wires) at 50 kHz with the software ModeLitz. This figure shows the total Joule power dissipated in each wire. The size of each wire is too small to enable to distinguish it individually.](image-2.png)
![Geometry and mesh for an inductor with 55 wires
Geometry and mesh for a portion of a multistrands inductor (5x11 wires) obtained thanks to the ModeLitz software](image-3.png)
![Local repartition of the Joule power density inside an inductor with 18 wires (Frequency 1 kHz)
Modeling of a part of a multistrands inductor (3x6 wires) with ModeLitz](image-4.png)
